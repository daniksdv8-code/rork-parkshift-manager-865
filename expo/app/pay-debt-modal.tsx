...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  avatarText: { fontSize: 18, fontWeight: '700' as const, color: colors.danger },
  clientName: { fontSize: 16, fontWeight: '600' as const, color: colors.text },
  clientDebt: { fontSize: 13, color: colors.danger, marginTop: 2 },
  debtDetail: {
    backgroundColor: colors.surface, borderRadius: 12, padding: 14,
    marginBottom: 12, borderWidth: 1, borderColor: colors.border,
  },
  debtDetailLabel: { fontSize: 12, color: colors.textTertiary },
  debtDetailDesc: { fontSize: 14, color: colors.text, marginTop: 4 },
  debtDetailAmount: { fontSize: 18, fontWeight: '700' as const, color: colors.danger, marginTop: 4 },
  amountCard: {
  ...
  amountValue: { fontSize: 28, fontWeight: '800' as const, color: colors.primary },
  input: {
    backgroundColor: colors.surface, borderRadius: 12, padding: 14,
