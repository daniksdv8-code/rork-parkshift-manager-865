...
const createStyles = (colors: ThemeColors) => StyleSheet.create({
  ...
  debtWarning: {
    ...
    marginBottom: 12, borderWidth: 1, borderColor: colors.danger + '20',
  },
  debtWarningText: { fontSize: 13, fontWeight: '600' as const, color: colors.danger },
  infoCard: {
    backgroundColor: colors.surface, borderRadius: 12, padding: 14,
    marginBottom: 12, borderWidth: 1, borderColor: colors.border, gap: 6,
  },
  ...
  earlyExitCard: {
    backgroundColor: colors.surface, borderRadius: 14, padding: 16,
    marginBottom: 16, borderWidth: 1, borderColor: colors.warning + '30',
  },
  earlyExitTitle: { fontSize: 16, fontWeight: '700' as const, color: colors.warning, marginTop: 8, marginBottom: 12 },
  ...
  earlyExitBtn: {
    backgroundColor: colors.warning, borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 4,
  },
  ...
  methodLabel: { fontSize: 13, fontWeight: '600' as const, color: colors.textSecondary, marginBottom: 8 },
  ...
  debtOptionActive: { backgroundColor: colors.dangerSurface, borderColor: colors.danger + '30' },
